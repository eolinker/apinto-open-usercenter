...
require (
	...
	github.com/eolinker/apinto-dashboard v1.2.1-beta.0.20251031025022-9389d3177c5e // indirect
...
replace github.com/hashicorp/go-plugin => github.com/hmzzrcs/go-plugin v1.5.1
