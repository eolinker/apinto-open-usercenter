...
//
//		//续期token
//		refreshReq := &client.RefreshTokenReq{RJwt: tokens.RJwt}
//		refreshToken, err := m.userCenterClient.RefreshToken(refreshReq)
//		if err != nil {
//			DoRedirect(w, request.Url)
//			return
//		}
//
//		//1.从ginCtx的header中拿到token，没拿到报错提醒用户重新登录
//		verifyToken, err = common.VerifyToken(tokens.RJwt, secret)
//		if err != nil {
//
//			DoRedirect(w, request.Url)
//			return
